...
import com.codeflix.admin.catalog.infrastructure.configuration.annotations.VideoEvents;
...
public class AmqpConfig {
    ...
    static class Admin {
        ...
        public Binding videoCreatedBinding(
                ...
                @VideoCreatedQueue QueueProperties queueProperties
        ) {
        ...
        public Binding videoEncodedBinding(
                ...
                @VideoEncodedQueue QueueProperties queueProperties
        ) {
            return BindingBuilder.bind(queue).to(exchange).with(queueProperties.getRoutingKey());
        }
    }
